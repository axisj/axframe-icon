...
export const AXFIMoreVertical: CustomizedSVGComponent = ({ ...props }) => (
  <SvgComponent
    viewBox="0 0 24 24"
    role="axf-icon"
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12 14.0899C10.8954 14.0899 10 13.158 10 12.0083L10 11.9917C10 10.842 10.8954 9.91007 12 9.91007C13.1046 9.91007 14 10.842 14 11.9917L14 12.0083C14 13.158 13.1046 14.0899 12 14.0899Z"
      fill="#C7CED9"
    />
    <path
      fillRule="evenodd"
